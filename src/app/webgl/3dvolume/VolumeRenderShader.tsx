...
type VolumeRenderUniforms = {
	uSize: THREE.Vector3 | number[],
	uRenderstyle: number,
	uRenderthreshold: number,
	uClim: THREE.Vector2 | number[],
	uData?: Data3DTexture | null,
	uCmdata?: Texture
}

const VolumeRenderShader = shaderMaterial(
  {
    uSize: new THREE.Vector3(1, 1, 1),
    uRenderstyle: 0,
    uRenderthreshold: 0.4,
    uClim: new THREE.Vector2(0, 1),
    uData: null,
    uCmdata: null
  },
...
extend({ VolumeRenderShader })

declare module '@react-three/fiber' {
  interface ThreeElements {
    volumeRenderShader: Object3DNode<
			VolumeRenderUniforms,
      typeof VolumeRenderShader
    >
  }
}
